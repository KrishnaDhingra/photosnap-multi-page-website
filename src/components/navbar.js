    ...
    return(
        <div className="navbar bg-white shadow-md flex justify-between md:justify-evenly px-4 sm:px-8 md:px-0 lg:px-7 py-4 items-center font-body">
            ...
            <ul className="hidden md:flex  text-xs font-semibold tracking-widest ">
                <Link to="/"><li className="mx-6 my-auto hover:text-gray-400 duration-300"><a href="">STORIES</a></li></Link>
                <Link to="/"><li className="mx-6 my-auto hover:text-gray-400 duration-300"><a href="">FEATURES</a></li></Link>
                <Link to="/"><li className="mx-6 my-auto hover:text-gray-400 duration-300"><a href="">PRICING</a></li></Link>
            </ul>
